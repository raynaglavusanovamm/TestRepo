...
namespace WebServiceAutomation.PutEndPoint
{
    ...
    public class TestPutEndPoint
    {
        ...
        private string getUrl = "http://localhost:8081/laptop-bag/webapi/api/find/";
        private string putUrl = "http://localhost:8081/laptop-bag/webapi/api/update";
        private string secureGetUrl = "http://localhost:8081/laptop-bag/webapi/secure/find/";
        private string securePutUrl = "http://localhost:8081/laptop-bag/webapi/secure/update";
        private string securePostUrl = "http://localhost:8081/laptop-bag/webapi/secure/add";
