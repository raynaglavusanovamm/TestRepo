...
namespace WebServiceAutomation.ParallelExecution
{
    ...
    {
        private string delayGetUrl = "http://localhost:8081/laptop-bag/webapi/delay/all";
        private string delayGetWithId = "http://localhost:8081/laptop-bag/webapi/delay/find/";
        private string delayPostUrl = "http://localhost:8081/laptop-bag/webapi/delay/add";
        private string delayPutUrl = "http://localhost:8081/laptop-bag/webapi/delay/update";
