...
namespace WebServiceAutomation.DeleteEndPoint
{
    ...
    public class TestDeleteEndPoint
    {
        ...
        private string deleteEndPoint = "http://localhost:8081/laptop-bag/webapi/api/delete/";
        private string secureDeleteUrl = "http://localhost:8081/laptop-bag/webapi/secure/delete/";
