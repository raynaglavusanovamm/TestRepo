...
namespace RestSharpLatest.PostRequest
{
    ...
    public class TestPostRequest
    {
        ...
        {
            int id = random.Next(1000);
            var xmlPayLoad = new XmlModelBuilder().WithId(id).WithBrandName("Test Brand Name").
                WithFeatures(new List<string>() { "Feature1", "Feature2" }).WithLaptopName("Test Laptop Name").Build();
